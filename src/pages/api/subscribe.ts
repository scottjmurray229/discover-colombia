...
const GUIDE_NAMES: Record<string, string> = {
  'destination-bogota': 'Bogot\u00e1 Travel Guide',
  'destination-medellin': 'Medell\u00edn Travel Guide',
  'destination-cartagena': 'Cartagena Travel Guide',
  'destination-santa-marta': 'Santa Marta Travel Guide',
  'destination-san-andres': 'San Andr\u00e9s Travel Guide',
  'destination-cali': 'Cali Travel Guide',
  'destination-villa-de-leyva': 'Villa de Leyva Travel Guide',
  'destination-salento': 'Salento Travel Guide',
  'destination-barichara': 'Barichara Travel Guide',
  'destination-leticia': 'Leticia Travel Guide',
  'destination-tatacoa-desert': 'Tatacoa Desert Travel Guide',
  'destination-providencia': 'Providencia Travel Guide',
};
  ...
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      <div style="background:linear-gradient(135deg,#0D7377,#14B8A6);padding:32px 28px;text-align:center;">
        <h1 style="color:white;font-size:24px;margin:0 0 8px;">Discovering Colombia</h1>
      ...
      <div style="padding:28px;">
        <p style="color:#1A2332;font-size:16px;line-height:1.65;margin:0 0 16px;">
          Welcome! You're now part of the Discovering Colombia community.
        </p>
        ...
        <div style="text-align:center;margin-bottom:24px;">
          <a href="https://discoveringcolombia.info/destinations/" style="display:inline-block;background:#0D7377;color:white;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;">Browse All Destinations</a>
        </div>
    ...
    <p style="color:#94A3B8;font-size:11px;text-align:center;margin:20px 0 0;line-height:1.5;">
      You're receiving this because you signed up at discoveringcolombia.info.<br>
      <a href="https://discoveringcolombia.info/legal/privacy/" style="color:#94A3B8;">Privacy Policy</a>
    </p>
  </div>
</body>
</html>`;
...
async function sendWelcomeEmail(apiKey: string, to: string, guideName: string): Promise<void> {
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      subject: `Your ${guideName} — Welcome to Discovering Colombia`,
