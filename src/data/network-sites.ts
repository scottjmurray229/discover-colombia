...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  {
    id: 'colombia',
    name: 'Discovering Colombia',
    shortName: 'Colombia',
    domain: 'discoveringcolombia.info',
    url: 'https://discoveringcolombia.info',
    flag: '\ud83c\udde8\ud83c\uddf4',
    region: 'south-america',
    status: 'live',
    tagline: 'Coffee, Caribbean coast, and Colombian rhythms',
  },
  // Europe
  {
    id: 'eastern-europe',
...
export const CURRENT_SITE_ID = 'colombia';
