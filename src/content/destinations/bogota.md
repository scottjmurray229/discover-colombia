...
budgetPerDay:
  ...
  midRange: 75
  luxury: 220
gettingThere: "Fly into El Dorado International Airport (BOG), Colombia's main hub with direct flights from Miami, Houston, New York, Madrid, and most Latin American capitals. Airport taxis to La Candelaria take 30-50 minutes and cost around COP 30,000 (~$7 USD). The TransMilenio bus system connects the airport to the city centre."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Cool highland — 7-18°C year-round" }
  - { icon: "💵", label: "Budget", value: "COP 100,000-900,000/day (~$25-220 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish" }
  - { icon: "⛰️", label: "Altitude", value: "2,640 metres above sea level" }
highlights:
  - "Explore the cobblestone streets and colonial facades of La Candelaria, Bogotá's historic heart"
  - "Marvel at 55,000 pre-Columbian gold artifacts at the world-renowned Museo del Oro"
  - "Ride the funicular or cable car to the summit of Monserrate for sweeping views across the city and the Andes"
relatedDestinations:
  - "medellin"
  - "cartagena"
faqItems:
...
affiliatePicks:
  - name: "Selina La Candelaria"
    type: "hotel"
    price: "COP 80,000 (~$20 USD)"
    personalNote: "A solid hostel-hotel hybrid right in the heart of La Candelaria. Great common areas, rooftop bar, and walking distance to everything in the historic centre."
    affiliateUrl: "#"
  - name: "Bogotá Graffiti Tour"
    type: "tour"
    price: "COP 60,000 (~$15 USD)"
    personalNote: "The original street art walking tour that put La Candelaria's murals on the map. Guides are passionate local artists who explain the political and cultural stories behind every piece."
    affiliateUrl: "#"
  - name: "Salt Cathedral of Zipaquirá Day Trip"
    type: "tour"
