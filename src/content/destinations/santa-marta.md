...
budgetPerDay:
  ...
  midRange: 60
  luxury: 180
gettingThere: "Fly into Simón Bolívar International Airport (SMR), just outside the city centre. Direct flights from Bogotá (1.5 hours) and Medellín (1.5 hours). A taxi from the airport to the historic centre costs COP 12,000 (~$3 USD). Buses from Cartagena take 4 hours and cost COP 40,000-60,000 (~$10-15 USD). From Bogotá, the bus ride is roughly 16-18 hours."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Hot tropical — 25-33°C year-round" }
  - { icon: "💵", label: "Budget", value: "COP 80,000-720,000/day (~$20-180 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish" }
  - { icon: "🏔️", label: "Geography", value: "Caribbean coast backed by Sierra Nevada" }
highlights:
  - "Hike through pristine jungle and swim in crystal-clear bays at Tayrona National Park"
  - "Trek four days through the Sierra Nevada to reach Ciudad Perdida, Colombia's legendary Lost City"
  - "Discover the unique geography where the world's highest coastal mountain range meets the Caribbean Sea"
relatedDestinations:
  - "cartagena"
  - "san-andres"
faqItems:
  - { question: "Is Santa Marta safe?", answer: "Santa Marta is generally safe for tourists in the areas visitors frequent — the historic centre, Taganga, and the routes to Tayrona and Minca. Use ride-hailing apps at night, keep valuables out of sight, and avoid isolated beach areas after dark. The Lost City trek is very safe — all licensed operators are well-managed and accompanied by armed guides due to historical sensitivities." }
  - { question: "Is Santa Marta worth visiting?", answer: "Absolutely. Santa Marta offers the most adventurous itinerary on Colombia's Caribbean coast: Tayrona National Park (some of the continent's most beautiful jungle-backed beaches), the Lost City trek (more dramatic than Machu Picchu in many ways), the mountain town of Minca, and the extraordinary geographical drama of the Sierra Nevada mountains meeting the Caribbean Sea." }
  - { question: "Best time to visit Santa Marta?", answer: "December through March and July through August are the driest months — best for the Lost City trek, Tayrona, and beach days. April, May, and October-November are the wettest. Tayrona closes periodically (usually February and May-June) for ecological recovery — check before you go. The Lost City can be done year-round, though the rainy season makes river crossings more challenging." }
  - { question: "How much does Santa Marta cost per day?", answer: "Santa Marta is very affordable as a base. Budget travelers in El Rodadero or the historic centre hostels can manage $20-35 USD/day. The big expenses are activities: the Lost City trek costs ~$350 USD all-inclusive (4 days, food, guide, accommodation). Tayrona entry is COP 89,000 (~$22 USD) per day. Budget accordingly for activity-heavy itineraries." }
  - { question: "Do I need a visa for Colombia?", answer: "US, Canadian, Australian, UK, and most EU nationals enter Colombia visa-free for up to 90 days. No prior application is required — just a valid passport with sufficient remaining validity." }
  - { question: "What is Santa Marta famous for?", answer: "Santa Marta is famous for being South America's oldest surviving city (founded 1525), the gateway to Tayrona National Park, the starting point of the Ciudad Perdida (Lost City) trek, the mountain town of Minca, and the extraordinary geography where the world's highest coastal mountain range (Sierra Nevada de Santa Marta) meets the Caribbean Sea." }
  - { question: "Is the Lost City trek worth the effort?", answer: "Without question. The four-day, 44-kilometre trek through the Sierra Nevada jungle to Ciudad Perdida is physically demanding — steep terrain, river crossings, heat, and humidity. But arriving at a 1,300-year-old stone city built by the Tairona people, older than Machu Picchu, surrounded by dense jungle and often shrouded in mist, is one of the most powerful experiences in Colombia." }
  - { question: "How many days should I spend in Santa Marta?", answer: "Plan at least 4-5 days to do it justice: one day exploring the city and Taganga, two days for Tayrona (with an overnight in hammocks or tents), and a day for Minca. If you are doing the Lost City trek, add 4-5 days. Santa Marta itself is a manageable base and works well as a launch point for multiple adventures." }
affiliatePicks:
  - name: "Lost City Trek (4 days)"
    type: "tour"
    price: "COP 1,400,000 (~$350 USD)"
    personalNote: "All licensed operators charge roughly the same price and use the same trail. The difference is in guide quality and group size. I recommend Expotur or Wiwa Tour — the latter is run by the indigenous Wiwa community and gives you a deeper cultural understanding of the Sierra Nevada."
    affiliateUrl: "#"
  - name: "Casa Elemento (Minca)"
    type: "hotel"
    price: "COP 60,000 (~$15 USD)"
    personalNote: "A mountain hostel above Minca with a famous giant hammock overlooking the valley. The views at sunrise are extraordinary. Basic accommodation but the setting more than compensates."
    affiliateUrl: "#"
  - name: "Tayrona Ecohabs"
    type: "hotel"
    price: "COP 500,000 (~$125 USD)"
    personalNote: "Thatched-roof cabins inside Tayrona Park at the Cañaveral sector. Waking up to the sound of howler monkeys and walking straight onto a jungle-backed beach is an experience that justifies the splurge."
    affiliateUrl: "#"
...
<immersive-break-inline videoSrc="/videos/destinations/santa-marta-hero.mp4" heading="Santa Marta: Where the Jungle Meets the Caribbean" subheading="Tayrona's beaches, the Lost City, and the Sierra Nevada rising from the sea" />
