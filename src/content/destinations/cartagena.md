...
budgetPerDay:
  ...
  midRange: 100
  luxury: 300
gettingThere: "Fly into Rafael Núñez International Airport (CTG), just 3 km from the walled city. Direct flights from Miami, Fort Lauderdale, New York, and major Colombian cities. Airport taxis to the old town cost COP 15,000-20,000 (~$4-5 USD). Buses from Bogotá take about 20 hours; from Santa Marta, about 4 hours."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical — 25-33°C year-round, humid" }
  - { icon: "💵", label: "Budget", value: "COP 140,000-1,200,000/day (~$35-300 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (Caribbean coast dialect)" }
  - { icon: "🏰", label: "UNESCO", value: "World Heritage Site since 1984" }
highlights:
  - "Wander through the UNESCO-listed walled old town with its pastel colonial buildings, flower-draped balconies, and cobblestone plazas"
  - "Explore the massive Castillo San Felipe de Barajas, the largest Spanish colonial fortress in the Americas"
  - "Escape to the Rosario Islands for turquoise waters, snorkelling, and fresh ceviche on the beach"
relatedDestinations:
  - "santa-marta"
  - "san-andres"
faqItems:
...
affiliatePicks:
  - name: "Casa Lola Cartagena"
    type: "hotel"
    price: "COP 350,000 (~$87 USD)"
    personalNote: "A beautifully restored colonial house in the heart of the walled city. The rooftop terrace has views over the cathedral dome and the sea. Worth every peso for the location and the morning coffee ritual alone."
    affiliateUrl: "#"
  - name: "Rosario Islands Snorkelling Day Trip"
    type: "tour"
    price: "COP 120,000 (~$30 USD)"
    personalNote: "A full day on the islands with boat transport, snorkelling equipment, lunch, and beach time. The coral reefs are colourful and the water clarity is excellent. Book through a reputable operator to avoid overcrowded boats."
    affiliateUrl: "#"
