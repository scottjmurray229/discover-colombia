...
budgetPerDay:
  ...
  midRange: 250000
  luxury: 600000
gettingThere: "From Bucaramanga, take a bus to San Gil (2.5-3 hours, COP 25,000-30,000 / ~$6-7 USD), then a colectivo or bus to Barichara (45 minutes, COP 7,000 / ~$1.65 USD). From Bogota, overnight buses reach San Gil in 6-7 hours (COP 50,000-70,000 / ~$12-16 USD). There is no airport in Barichara — Bucaramanga's Palonegro Airport is the nearest."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Warm highland / 22-28°C (72-82°F)" }
  - { icon: "💵", label: "Budget", value: "COP 100,000-600,000/day (~$24-141 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (very limited English)" }
  - { icon: "🏔️", label: "Altitude", value: "1,336 m (4,383 ft)" }
highlights:
  - "Walk the ancient Camino Real stone path from Barichara to the tiny village of Guane"
  - "Explore stone-paved streets and whitewashed colonial architecture declared a National Monument"
  - "Visit artisan workshops crafting with fique fiber, paper, stone, and clay using centuries-old techniques"
  - "Stand at the mirador overlooking the dramatic Suarez River canyon"
  - "Experience genuine small-town Colombian life far from the tourist circuit"
gradientColors: "from-amber-900 via-yellow-800 to-stone-900"
relatedDestinations:
  - "villa-de-leyva"
  - "bogota"
  - "salento"
...
affiliatePicks:
  - name: "Hotel Corata Boutique"
    type: "hotel"
    price: "COP 350,000/night (~$82 USD)"
    personalNote: "A beautifully restored colonial house with thick stone walls, a lush interior garden, and rooms that manage to feel both historic and deeply comfortable. Waking up here and walking out to the cobblestone streets felt like stepping into another century."
    affiliateUrl: "#"
  - name: "Hostal Color de Hormiga"
    type: "hotel"
    price: "COP 55,000/night (~$13 USD)"
    personalNote: "A cheerful budget option with clean rooms arranged around a small courtyard. The name references the famous hormigas culonas (big-bottomed ants) that are a local delicacy. The owner is a generous host who will tell you everything you need to know about the area."
    affiliateUrl: "#"
  - name: "San Gil Rafting and Adventure Day"
    type: "activity"
    price: "COP 80,000 (~$19 USD)"
    personalNote: "If you want to balance Barichara's tranquility with some adrenaline, the white-water rafting on the Rio Fonce from San Gil is excellent. Class III-IV rapids depending on the season and your comfort level."
    affiliateUrl: "#"
