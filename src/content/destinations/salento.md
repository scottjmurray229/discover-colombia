...
budgetPerDay:
  ...
  midRange: 250000
  luxury: 550000
gettingThere: "Fly into Armenia (El Eden Airport) or Pereira (Matecana Airport), then take a bus or shared jeep to Salento (45-60 minutes, COP 9,000-12,000 / ~$2-3 USD). From Bogota, direct buses run overnight to Armenia (8-9 hours, COP 55,000-75,000 / ~$13-18 USD). Willys jeeps shuttle between Salento's plaza and the Cocora Valley trailhead throughout the day."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Mild highland / 15-24°C (59-75°F)" }
  - { icon: "💵", label: "Budget", value: "COP 100,000-550,000/day (~$24-130 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (some English in tourism)" }
  - { icon: "🏔️", label: "Altitude", value: "1,895 m (6,217 ft)" }
highlights:
  - "Hike through the Cocora Valley surrounded by the world's tallest palm trees reaching 60 meters"
  - "Tour a working coffee finca and learn the bean-to-cup process from farmers who have grown coffee for generations"
  - "Wander Salento's colorful Calle Real lined with Paisa-style architecture and artisan shops"
  - "Sample fresh trout pulled from mountain streams, prepared a dozen different ways"
  - "Ride a classic Willys jeep through the lush green mountains of the Coffee Axis"
...
affiliatePicks:
  - name: "Coffee Farm Tour with Finca El Ocaso"
    ...
    personalNote: "The most comprehensive coffee tour I have done in the region. The guide walked us through the entire process from seedling to cup, and the tasting at the end was genuinely revelatory. I finally understood why Colombian coffee commands the prices it does."
    affiliateUrl: "#"
  - name: "The Plantation House Hostel"
    type: "hotel"
    price: "COP 45,000/night dorm (~$11 USD)"
    personalNote: "A social hostel with a spectacular setting on the edge of town. The views from the terrace across the valley are reason enough to stay here. The common areas are well designed and the staff organizes group activities and tours."
    affiliateUrl: "#"
  - name: "Hotel Salento Real"
    type: "hotel"
    price: "COP 220,000/night (~$52 USD)"
    personalNote: "A comfortable mid-range option with warm rooms, good showers, and a generous breakfast. Located just a couple of blocks from the plaza, which is ideal for the pre-dawn start needed to beat the Cocora Valley crowds."
    affiliateUrl: "#"
  - name: "Cocora Valley and Coffee Farm Combo Tour"
    type: "tour"
    price: "COP 120,000 (~$28 USD)"
    personalNote: "If you want both the valley hike and a coffee tour wrapped into a single guided day, this combo is efficient and well-organized. The guide provides context about the ecology and the coffee industry that you would miss going independently."
    affiliateUrl: "#"
