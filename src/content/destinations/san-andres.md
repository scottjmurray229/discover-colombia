...
heroImage: ""
tagline: "The Sea of Seven Colors"
region: "caribbean"
...
budgetPerDay:
  ...
  midRange: 80
  luxury: 250
gettingThere: "Fly into Gustavo Rojas Pinilla International Airport (ADZ) on the island. Direct flights from Bogotá (2.5 hours), Medellín (2 hours), and Cartagena (1.5 hours). Upon arrival, you must purchase a tourist card (tarjeta de turismo) for COP 130,000 (~$32 USD) — have cash or a card ready. The airport is walking distance from the main town centre."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical Caribbean — 26-30°C year-round" }
  - { icon: "💵", label: "Budget", value: "COP 120,000-1,000,000/day (~$30-250 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish, English Creole" }
  - { icon: "🌊", label: "Known For", value: "Mar de Siete Colores (Sea of Seven Colors)" }
highlights:
  - "Swim and snorkel in the legendary Sea of Seven Colors — shifting shades of turquoise, blue, and green created by the island's unique coral and sand formations"
  - "Take a boat to Johnny Cay, a tiny palm-fringed islet with reggae music, fresh seafood, and crystal-clear water"
  - "Explore the island's Raizal culture — a unique Afro-Caribbean heritage blending English Creole, reggae, and island traditions"
relatedDestinations:
  - "cartagena"
  - "santa-marta"
faqItems:
  - { question: "Is San Andrés safe?", answer: "San Andrés is generally safe for tourists in the main tourist areas — El Centro, El Cove, the beaches, and the Johnny Cay area. Use standard urban caution at night: ride-hailing apps rather than walking in unfamiliar streets, keep phones in pockets, avoid quiet areas after midnight. Petty theft is the primary concern rather than serious crime." }
  - { question: "Is San Andrés worth visiting?", answer: "Yes, particularly if you are already in Colombia and want a Caribbean island without the cost of international Caribbean alternatives. The Sea of Seven Colors is genuinely spectacular — the water clarity and shifting color bands from turquoise to deep blue are unique to this island's reef and sand formations. Johnny Cay, the golf cart circuit, and the reggae Raizal culture add real depth." }
  - { question: "Best time to visit San Andrés?", answer: "January through April and November are the calmest and driest months — best for snorkeling visibility. May through October sees more rain and occasional rough seas. December brings holiday crowds from mainland Colombia. If you want the clearest water and fewest crowds, go in January or February." }
  - { question: "How much does San Andrés cost per day?", answer: "San Andrés is mid-range by Colombian standards. Budget travelers in basic guesthouses can manage $30-45 USD/day. Mid-range visitors at a beach hotel should budget $80-130 USD/day. Add the mandatory tourist card ($32 USD on arrival) and flights from Bogotá ($60-120 USD one way)." }
  - { question: "Do I need a visa for Colombia?", answer: "US, Canadian, Australian, UK, and most EU nationals enter Colombia visa-free for up to 90 days. The San Andrés tourist card (tarjeta de turismo, COP 130,000) is a separate mandatory fee paid on arrival — it is not a visa but a conservation and development fund contribution." }
  - { question: "What is San Andrés famous for?", answer: "San Andrés is famous for the Mar de Siete Colores (Sea of Seven Colors) — water that shifts through seven distinct shades of blue, turquoise, and green due to the unique coral and sand formations. Johnny Cay, West View snorkeling, the island's Raizal Afro-Caribbean culture, and being one of Colombia's most popular domestic beach destinations are also well-known." }
  - { question: "What is the tourist card and why do I need it?", answer: "All visitors to San Andrés must purchase a tarjeta de turismo upon arrival at the airport. It costs COP 130,000 (~$32 USD) and can be paid in cash or by card. The card is checked at hotels and sometimes at attractions. It is a mandatory fee — have the payment ready before landing to avoid long queues at the counter." }
  - { question: "Is San Andrés better than Providencia?", answer: "They are very different experiences. San Andrés is larger, more developed, more touristy, and easier to reach. Providencia is smaller, quieter, more expensive to get to, and feels like a step back in time. If you want convenience, nightlife, and easy snorkelling, San Andrés is your pick. If you want untouched Caribbean charm with more effort, Providencia is extraordinary." }
affiliatePicks:
  - name: "Johnny Cay Boat Trip"
    type: "tour"
    price: "COP 50,000 (~$12 USD)"
    personalNote: "The boat ride takes ten minutes, and the tiny island delivers perfectly on the Caribbean fantasy — palm trees, reggae, turquoise water, and fried fish served on paper plates. Go early before the crowds build."
    affiliateUrl: "#"
  - name: "West View Snorkelling"
    type: "activity"
    price: "COP 15,000 (~$4 USD)"
    personalNote: "A natural pool on the west coast where you can snorkel directly from the platform. The fish are abundant and unafraid — you do not need to go far to see angelfish, parrotfish, and the occasional ray. Bring your own gear or rent it on site."
    affiliateUrl: "#"
  - name: "Island Circuit by Golf Cart"
    type: "activity"
    price: "COP 150,000 (~$37 USD)"
    personalNote: "Rent a golf cart for the day and drive the 30-kilometre ring road around the island at your own pace. Stop at West View, the Hoyo Soplador, La Piscinita, and San Luis beach. It is the most fun way to see everything."
    affiliateUrl: "#"
...
<immersive-break-inline videoSrc="/videos/destinations/san-andres-hero.mp4" heading="San Andrés: Colombia's Sea of Seven Colors" subheading="Johnny Cay, reggae culture, and water that shifts through seven shades of blue" />
...
1. **See the water from the air.** If you have a window seat on the approach, keep your eyes open. The view of the seven colours from above is genuinely breathtaking and gives you context for everything you will see at sea level.

2. **Rent a golf cart and do the full island circuit.** It is the most enjoyable way to see San Andrés. Stop everywhere. Swim at West View. Eat fried fish in San Luis. Watch the Hoyo Soplador. Wade to Rocky Cay. You will cover the whole island in a relaxed day.

3. **Eat rondón in San Luis, not in the tourist centre.** The Raizal families in San Luis have been making this coconut stew for generations. Ask at local restaurants — Miss Celia's and similar spots serve the real thing.

4. **Get to Johnny Cay on the first boat.** The island is tiny, and by midday it is packed. Early arrivals get the best beach spots, calmer water for snorkelling, and a few quiet hours before the crowds roll in.

5. **Bring your own snorkelling gear.** Rental gear is available everywhere but the quality varies wildly. If you have your own mask, snorkel, and fins, you will be happier and save money across multiple spots.

6. **Budget for the tourist card.** The COP 130,000 fee catches many travellers off guard. Factor it into your trip budget from the start so it does not sting on arrival. *Así es la vida* — that is just how it is here.
