...
relatedDestinations:
  ...
  - "santa-marta"
faqItems:
  - { question: "What is the tourist card and why do I need it?", answer: "All visitors to San Andrés must purchase a tarjeta de turismo upon arrival at the airport. It costs COP 130,000 (~$32 USD) and can be paid in cash or by card. The card is checked at hotels and sometimes at attractions. It is a mandatory fee — there is no way around it. Have the payment ready before landing to avoid long queues at the counter." }
  - { question: "Is San Andrés better than Providencia?", answer: "They are very different experiences. San Andrés is larger, more developed, more touristy, and easier to reach. Providencia is smaller, quieter, more expensive to get to, and feels like a step back in time. If you want convenience, nightlife, and easy snorkelling, San Andrés is your pick. If you want untouched Caribbean charm and are willing to make the extra effort, Providencia is extraordinary. Ideally, visit both." }
  - { question: "How many days do I need in San Andrés?", answer: "Three to four days is the sweet spot. One day for the island circuit by golf cart or motorbike, one day for Johnny Cay and snorkelling, one day for the aquarium and deeper diving or snorkelling at the cays, and an optional day for relaxation, the Hoyo Soplador, or a trip to Providencia. More than four days and you may feel you have covered everything." }
affiliatePicks:
