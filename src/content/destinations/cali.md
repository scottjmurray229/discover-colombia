...
budgetPerDay:
  ...
  midRange: 60
  luxury: 180
gettingThere: "Fly into Alfonso Bonilla Aragón International Airport (CLO) in Palmira, about 30 minutes east of the city centre. Direct flights from Bogotá (1 hour), Medellín (1 hour), and Cartagena (1.5 hours). International connections through Miami, Panama City, and other Latin American hubs. Airport taxis cost COP 60,000-80,000 (~$15-20 USD) to the city centre. Buses from Bogotá take about 10 hours."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical — 19-30°C, warm days and mild evenings" }
  - { icon: "💵", label: "Budget", value: "COP 80,000-720,000/day (~$20-180 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (caleño accent)" }
  - { icon: "💃", label: "Identity", value: "La Capital Mundial de la Salsa" }
highlights:
  - "Dance salsa in the legendary clubs of Juanchito and Barrio Obrero where the music never stops"
  - "Stand at the feet of the Cristo Rey statue for panoramic views over the city and the sugarcane-quilted Cauca Valley"
  - "Experience Cali's deep Afro-Colombian culture through music, food, and the vibrant energy of the Feria de Cali"
relatedDestinations:
  - "bogota"
  - "medellin"
faqItems:
...
affiliatePicks:
  - name: "Salsa Lesson (Beginner)"
    type: "activity"
    price: "COP 40,000 (~$10 USD)"
    personalNote: "Take a class before hitting the clubs. Two hours of basic steps and partner work will give you enough confidence to hold your own on the dance floor. Swing Latino academy in San Antonio is one of the best."
    affiliateUrl: "#"
  - name: "Tin Tin Deo"
    type: "activity"
    price: "COP 20,000 (~$5 USD)"
    personalNote: "The most famous salsoteca in Cali. Small, packed, and loud in the best way. The dance floor is tiny, which means everyone is close and the energy is electric. Go on a Thursday or Friday night when the local crowd fills the room."
    affiliateUrl: "#"
  - name: "Cristo Rey and San Antonio Walking Tour"
    type: "tour"
    price: "COP 60,000 (~$15 USD)"
    personalNote: "A guided half-day walk through the San Antonio neighbourhood and up to Cristo Rey. Covers the neighbourhood's history, art scene, and viewpoints. The Cristo Rey approach on foot is steep but the panoramic reward is worth the climb."
    affiliateUrl: "#"
...
1. **Take a salsa lesson before you go out.** Two hours of basic instruction makes the difference between standing awkwardly at the edge of the dance floor and actually participating in the magic. Every peso spent on a lesson pays dividends in confidence.

2. **Go to Tin Tin Deo on a Thursday night.** The crowd is local, the music is classic salsa dura, and the dance floor is so small that the energy becomes something collective and transcendent. It is the essential Cali experience.

3. **Base yourself in San Antonio.** The neighbourhood has the best balance of character, safety, food, and walkability. Morning coffee with a view of the city, afternoon wandering, evening salsa — San Antonio puts it all within reach.

4. **Drink lulada instead of beer on hot afternoons.** This lulo fruit drink is uniquely Cali, refreshing beyond description, and costs less than COP 5,000. Find it at street stands and juice bars throughout the city.

5. **Eat the chuleta valluna at a local restaurant, not a tourist one.** The best versions are in the Alameda neighbourhood and at small restaurants where the plate costs COP 15,000 and the pork chop is the size of your head. Ask for extra ají.

6. **Visit Cristo Rey in the early morning for clear views.** The valley haze builds quickly after mid-morning. Go at 7 or 8 AM for the most dramatic panorama. Take a taxi — do not walk the approach road.
