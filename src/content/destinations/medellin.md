...
budgetPerDay:
  ...
  midRange: 70
  luxury: 200
gettingThere: "Fly into José María Córdova International Airport (MDE) in Rionegro, about 45 minutes east of the city by bus (COP 15,000 / ~$4 USD) or taxi (COP 90,000 / ~$22 USD). Domestic flights connect from Bogotá (1 hour), Cartagena (1.5 hours), and Cali (1 hour). Long-distance buses from Bogotá take about 9 hours."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Subtropical highland — 18-28°C year-round" }
  - { icon: "💵", label: "Budget", value: "COP 100,000-800,000/day (~$25-200 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (paisa dialect)" }
  - { icon: "🌤️", label: "Nickname", value: "La Ciudad de la Eterna Primavera" }
highlights:
  - "Ride the Metrocable gondolas over hillside barrios for breathtaking panoramic views of the Aburrá Valley"
  - "Witness the astonishing transformation of Comuna 13 through its vibrant street art, escalators, and community pride"
  - "Explore the chubby sculptures of Fernando Botero at Plaza Botero in the city centre"
relatedDestinations:
  - "bogota"
  - "santa-marta"
faqItems:
...
affiliatePicks:
  - name: "Real City Walking Tour Medellín"
    ...
    personalNote: "The best introduction to Medellín I have found. Knowledgeable local guides walk you through the city centre, Plaza Botero, and explain the transformation from Colombia's darkest era to the innovation capital it is today."
    affiliateUrl: "#"
  - name: "Comuna 13 Graffiti Tour"
    type: "tour"
    price: "COP 80,000 (~$20 USD)"
    personalNote: "Go with a local guide from the community. They share first-hand stories of the neighbourhood's past and the grassroots efforts that turned it into one of the most visited places in all of Colombia."
    affiliateUrl: "#"
  - name: "Coffee Farm Day Trip (Jardín)"
    type: "tour"
