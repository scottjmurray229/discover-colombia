...
budgetPerDay:
  ...
  midRange: 200000
  luxury: 400000
gettingThere: "From Neiva (the capital of Huila, served by Benito Salas Airport), take a bus to Villavieja (1 hour, COP 8,000-10,000 / ~$2-2.35 USD), then a mototaxi or colectivo into the desert (15-20 minutes, COP 8,000-15,000 / ~$2-3.50 USD). From Bogota, buses to Neiva take 5-6 hours (COP 40,000-55,000 / ~$9-13 USD). The Tatacoa Observatory is about 3 km from the main accommodation cluster."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Hot and arid / 28-40°C (82-104°F)" }
  - { icon: "💵", label: "Budget", value: "COP 80,000-400,000/day (~$19-94 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (almost no English)" }
  - { icon: "🏔️", label: "Altitude", value: "430 m (1,411 ft)" }
highlights:
  - "Walk through the surreal red labyrinth of the Cuzco area, sculpted by millions of years of erosion"
  - "Stargaze at the Tatacoa Astronomical Observatory under some of Colombia's darkest skies"
  - "Explore the grey moonscape of Los Hoyos, a stark contrast to the red desert"
  - "Swim in the natural desert pool fed by underground springs"
  - "Experience one of Colombia's most otherworldly and least-visited landscapes"
gradientColors: "from-red-900 via-orange-900 to-stone-800"
relatedDestinations:
  - "bogota"
  - "villa-de-leyva"
  - "leticia"
...
affiliatePicks:
  - name: "Bethel Bio Luxury Hotel"
    ...
    personalNote: "The most comfortable option in the desert with a pool, air conditioning, and surprisingly good food. After a morning of hiking through 40-degree heat, returning to a cool room and a cold pool felt like salvation."
    affiliateUrl: "#"
  - name: "Camping Noches de Saturno"
    type: "hotel"
    price: "COP 40,000/night (~$9 USD)"
    personalNote: "Basic but atmospheric. Hammocks and tents under the open sky, with the Milky Way visible directly above. The facilities are simple — shared bathrooms, cold showers — but the experience of sleeping in the desert under the stars is worth the rustic conditions."
    affiliateUrl: "#"
  - name: "Tatacoa Astronomical Observatory Night Session"
    type: "activity"
    price: "COP 15,000 (~$3.50 USD)"
    personalNote: "The nightly stargazing session run by the observatory astronomer is exceptional. Through the telescope, I saw Saturn's rings, Jupiter's moons, and the craters of our own moon with a clarity that took my breath away. The astronomer's explanations are engaging even for complete novices."
    affiliateUrl: "#"
