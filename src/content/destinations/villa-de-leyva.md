...
budgetPerDay:
  ...
  midRange: 300000
  luxury: 700000
gettingThere: "Take a direct bus from Bogota's Terminal de Transportes to Villa de Leyva (approximately 4 hours, COP 35,000-45,000 / ~$9-11 USD). Buses depart frequently throughout the day. Alternatively, drive via the Tunja bypass — the road is paved and scenic but winding through the Boyaca highlands."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Cool highland / 14-20°C (57-68°F)" }
  - { icon: "💵", label: "Budget", value: "COP 120,000-700,000/day (~$28-165 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (limited English)" }
  - { icon: "🏔️", label: "Altitude", value: "2,149 m (7,051 ft)" }
highlights:
  - "Stand in awe at the Plaza Mayor, Colombia's largest cobblestone plaza spanning 14,000 square meters"
  - "Discover a 120-million-year-old Kronosaurus fossil at the Paleontological Museum"
  - "Hike the desert-like terrain of the Desierto de la Candelaria and its ancient monastery"
  - "Explore artisan workshops producing handwoven textiles and pottery in the colonial streets"
  - "Visit the Astronomic Observatory of Muisca at El Infiernito, Colombia's Stonehenge"
gradientColors: "from-amber-900 via-stone-800 to-yellow-900"
relatedDestinations:
  - "bogota"
  - "barichara"
  - "tatacoa-desert"
...
affiliatePicks:
  - name: "Hotel Boutique Plazuela de San Agustin"
    type: "hotel"
    price: "COP 280,000/night (~$66 USD)"
    personalNote: "A beautifully restored colonial building just steps from the plaza. The interior courtyard with its fountain and climbing flowers is the kind of place where you lose entire afternoons reading."
    affiliateUrl: "#"
  - name: "Bogota to Villa de Leyva Guided Day Tour"
    type: "tour"
    price: "COP 250,000 (~$59 USD)"
    personalNote: "If you are short on time, this guided tour from Bogota covers the main highlights including the plaza, fossil museum, and El Infiernito. Not my preferred way to experience the town, but it covers ground efficiently."
    affiliateUrl: "#"
  - name: "Posada de San Antonio"
    type: "hotel"
    price: "COP 140,000/night (~$33 USD)"
    personalNote: "A midrange option with clean rooms, warm blankets for the chilly nights, and a filling breakfast included. The owner is a wealth of local knowledge and helped me find trails I never would have discovered on my own."
    affiliateUrl: "#"
