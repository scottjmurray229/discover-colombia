...
heroImage: ""
tagline: "The Caribbean's Best-Kept Secret"
region: "caribbean"
...
budgetPerDay:
  ...
  midRange: 400000
  luxury: 900000
gettingThere: "Fly from Bogota to San Andres (approximately 2 hours), then take a small propeller plane from San Andres to Providencia (20 minutes, COP 250,000-450,000 / ~$59-106 USD round trip) or a catamaran ferry (3-4 hours, COP 200,000-300,000 / ~$47-70 USD round trip, rough seas common). There are no direct flights from mainland Colombia to Providencia — San Andres is the mandatory transit point."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical Caribbean / 26-32°C (79-90°F)" }
  - { icon: "💵", label: "Budget", value: "COP 180,000-900,000/day (~$42-212 USD)" }
  - { icon: "🗣️", label: "Language", value: "Creole English, Spanish" }
  - { icon: "🏔️", label: "Altitude", value: "0-360 m (0-1,181 ft)" }
highlights:
  - "Snorkel the crystal-clear waters of Crab Cay surrounded by the world's third-largest barrier reef"
  - "Explore the UNESCO-listed Old Providence McBean Lagoon National Natural Park"
  - "Hike to The Peak (El Pico) for panoramic views over the island and the sea of seven colors"
  - "Experience authentic Raizal culture — the Afro-Caribbean-English community unique to these islands"
  - "Swim in waters so clear you can see the bottom at 30 meters"
gradientColors: "from-cyan-900 via-blue-800 to-teal-900"
relatedDestinations:
  - "san-andres"
  - "cartagena"
  - "santa-marta"
faqItems:
  - { question: "Is Providencia safe?", answer: "Providencia is one of Colombia's safest destinations — a tiny island with a small, tight-knit Raizal community and almost zero crime. The biggest risks are logistical: rough sea crossings if you take the ferry instead of the plane, and limited medical facilities if something goes wrong. Travel insurance with evacuation coverage is sensible." }
  - { question: "Is Providencia worth visiting?", answer: "For serious beach and reef travelers, it is one of the Caribbean's great secrets. The water clarity is extraordinary (the UNESCO-listed reef is among the healthiest in the Western Caribbean), the Raizal culture is genuinely fascinating, and the island sees far fewer tourists than comparable Caribbean destinations. The effort and cost of getting there is real — but so is the reward." }
  - { question: "Best time to visit Providencia?", answer: "January through April and November through December offer the calmest seas and driest weather. July through October is hurricane season — the island was devastated by Hurricane Iota in November 2020 and risk remains. Late December brings holiday crowds. January-March is the sweet spot for weather, reef conditions, and manageable visitor numbers." }
  - { question: "How much does Providencia cost per day?", answer: "Relative to mainland Colombia, yes. Everything must be shipped or flown in, which increases costs. Budget travelers can manage $42-60 USD/day in a Raizal guesthouse. Mid-range visitors should budget $94-150 USD/day. Add $60-110 USD for the San Andres-Providencia flight and the mandatory CORALINA tourist card (~$31 USD)." }
  - { question: "How do I get to Providencia?", answer: "You must transit through San Andres. From San Andres, fly on a small propeller plane (20 minutes, Satena airline) or take the catamaran ferry (3-4 hours). I strongly recommend flying — the catamaran crosses open Caribbean Sea and can be extremely rough. Book the Satena flight well in advance as seats are limited." }
  - { question: "What is Providencia famous for?", answer: "Providencia is famous for its UNESCO-listed Old Providence McBean Lagoon (world's third-largest barrier reef system), the Sea of Seven Colors, Crab Cay snorkeling, and its authentic Raizal culture — an Afro-Caribbean community speaking English Creole that is completely distinct from mainland Colombia. It is one of the Caribbean's best-kept secrets." }
  - { question: "How many days should I spend on Providencia?", answer: "Four to five days is ideal. This allows time for snorkeling at Crab Cay, exploring McBean Lagoon, hiking The Peak, visiting the beaches, and simply absorbing the island's pace. Do not rush Providencia — its greatest quality is the absence of hurry." }
  - { question: "Has Providencia recovered from Hurricane Iota?", answer: "Hurricane Iota devastated Providencia in November 2020. The island has undergone significant reconstruction. Most tourism infrastructure including hotels, restaurants, and dive shops has been rebuilt. The reef and marine life have shown remarkable resilience. The island is fully open to visitors and the community warmly welcomes the tourism income that supports recovery." }
affiliatePicks:
  - name: "Deep Blue Hotel"
    type: "hotel"
    price: "COP 550,000/night (~$130 USD)"
    personalNote: "The most comfortable accommodation on the island with ocean views, air conditioning, and a terrace restaurant. After snorkeling all day, sitting on the terrace watching the sunset over the Caribbean with a cold beer in hand felt like the reward for every effort it took to reach this island."
    affiliateUrl: "#"
  - name: "Crab Cay Snorkeling Boat Trip"
    type: "activity"
    price: "COP 70,000 (~$16 USD)"
    personalNote: "The boat trip to Crab Cay was the highlight of my time on Providencia. The water clarity was unlike anything I have experienced — I could see individual grains of sand on the bottom at remarkable depth. Schools of tropical fish, rays, and healthy coral everywhere."
    affiliateUrl: "#"
  - name: "Posada del Mar"
    type: "hotel"
    price: "COP 200,000/night (~$47 USD)"
    personalNote: "A Raizal-run guesthouse with simple but clean rooms, home-cooked meals that showcase authentic island cuisine, and a host family that made me feel genuinely welcome. Staying with a local family is the best way to understand Providencia's culture."
    affiliateUrl: "#"
  - name: "Two-Tank Scuba Diving Trip"
    type: "activity"
    price: "COP 350,000 (~$82 USD)"
    personalNote: "Providencia's reef is part of the UNESCO Seaflower Biosphere Reserve and the diving is extraordinary. Healthy hard corals, abundant fish life, and visibility that routinely exceeds 30 meters. The dive operators are professional and safety-conscious."
    affiliateUrl: "#"
...
<immersive-break-inline videoSrc="/videos/destinations/providencia-hero.mp4" heading="Providencia: The Caribbean's Best-Kept Secret" subheading="UNESCO reef, Raizal culture, and water clarity that doesn't look real" />
