...
budgetPerDay:
  ...
  midRange: 350000
  luxury: 800000
gettingThere: "Fly from Bogota to Leticia's Alfredo Vasquez Cobo Airport (approximately 1 hour 45 minutes). LATAM and Avianca operate daily flights, with fares typically COP 250,000-500,000 (~$59-118 USD) one way. There are no roads connecting Leticia to the rest of Colombia — air is the only practical way in. From Leticia, you can walk across the border into Tabatinga, Brazil, or take a boat across the Amazon to Santa Rosa, Peru."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical / 25-35°C (77-95°F), humid year-round" }
  - { icon: "💵", label: "Budget", value: "COP 150,000-800,000/day (~$35-188 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish, Portuguese, Ticuna, and other indigenous languages" }
  - { icon: "🏔️", label: "Altitude", value: "96 m (315 ft)" }
highlights:
  - "Spot pink river dolphins (boto) surfacing in the tributaries of the Amazon"
  - "Walk across the international border from Colombia into Brazil in minutes"
  - "Stay in a jungle lodge surrounded by primary rainforest and howler monkey calls"
  - "Visit indigenous Ticuna and Yagua communities and learn about traditional Amazon lifeways"
  - "Navigate the Amazon River and its tributaries by motorized canoe through the world's largest rainforest"
gradientColors: "from-green-950 via-emerald-900 to-teal-900"
relatedDestinations:
  - "bogota"
  - "tatacoa-desert"
faqItems:
...
affiliatePicks:
  - name: "Amazon Jungle Lodge 3-Night Package"
    type: "tour"
    price: "COP 900,000 (~$212 USD)"
    personalNote: "This all-inclusive jungle lodge experience is the best way to experience the Amazon. Three nights in a riverside lodge with guided jungle treks, canoe trips, night safaris, fishing, and community visits. The sounds of the forest at night alone are worth the trip."
    affiliateUrl: "#"
  - name: "Hotel Decameron Decalodge Ticuna"
    type: "hotel"
    price: "COP 380,000/night (~$89 USD)"
    personalNote: "The most comfortable hotel in Leticia proper, with a pool, air conditioning that actually works, and a decent restaurant. After several days in a jungle lodge, the cool air and hot shower here feel like extraordinary luxury."
    affiliateUrl: "#"
  - name: "Amazon Dolphin Watching Boat Tour"
    type: "tour"
    price: "COP 80,000 (~$19 USD)"
    personalNote: "A half-day boat trip to the spots where pink and grey river dolphins are most commonly seen. Our guide knew exactly where to go, and within twenty minutes we had dolphins surfacing within meters of the boat. One of the most magical wildlife encounters I have had."
    affiliateUrl: "#"
  - name: "Hospedaje Mahatu"
    type: "hotel"
    price: "COP 80,000/night (~$19 USD)"
    personalNote: "A clean, no-frills guesthouse in central Leticia with air conditioning (essential), hot water, and friendly management. Nothing fancy, but everything you need as a base between jungle excursions."
    affiliateUrl: "#"
